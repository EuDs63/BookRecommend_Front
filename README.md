...
- 最后登录时间(last_login_time):日期时间类型,datetime
...
- 收藏- 时间(collect_time): 日期时间类型,datetime
...
- 评分时间(rating_time): 日期- 时间类型,datetime
